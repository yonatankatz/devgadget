...
var md5_output = document.getElementById('md5_output');
...
var computeHashValues = function() {
	...
	md5_output.value = md5(input.value);
	sha1_output.value = SHA1(input.value);
	sha256_output.value = SHA256(input.value);
	sha512_output.value = SHA512(input.value);
